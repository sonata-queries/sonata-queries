...
action do_init_app_metadata(){
	...
	modify_field(meta_app_data.drop_30008, 0);
	modify_field(meta_app_data.satisfied_30008, 0);
...
// query 30008
header_type out_header_30008_t {
	fields {
		qid : 16;
		ipv4_dstIP : 32;
	}
}
header out_header_30008_t out_header_30008;

action drop_30008(){
	modify_field(meta_app_data.drop_30008, 1);
}

action do_mark_satisfied_30008(){
	modify_field(meta_app_data.satisfied_30008, 1);
	modify_field(meta_app_data.clone, 1);
}

action do_add_out_header_30008(){
	add_header(out_header_30008);
	modify_field(out_header_30008.qid, meta_mapinit_30008_1.qid);
	modify_field(out_header_30008.ipv4_dstIP, meta_mapinit_30008_1.ipv4_dstIP);
}

table add_out_header_30008 {
	actions {
		do_add_out_header_30008;
	}
	size : 1;
}

table mark_satisfied_30008 {
	actions {
		do_mark_satisfied_30008;
	}
	size : 1;
}

// MapInit of query 30008
header_type meta_mapinit_30008_1_t {
	fields {
		qid: 16;
		ipv4_dstIP: 32;
	}
...
metadata meta_mapinit_30008_1_t meta_mapinit_30008_1;

action do_mapinit_30008_1(){
	modify_field(meta_mapinit_30008_1.qid, 30008);
	modify_field(meta_mapinit_30008_1.ipv4_dstIP, ipv4.dstIP);
}

table mapinit_30008_1 {
	actions {
		do_mapinit_30008_1;
	}
	size : 1;
...
// Filter 2 of query 30008
table filter_30008_2 {
	reads {
		ipv4.dstIP: lpm;
	}
	actions {
...
// Map 3 of query 30008
action do_map_30008_3(){
	bit_and(meta_mapinit_30008_1.ipv4_dstIP, meta_mapinit_30008_1.ipv4_dstIP, 0xff000000);
}
...
control ingress {
	apply(init_app_metadata);
		...
		// query 30008
		if (meta_app_data.drop_30008 != 1) {
			apply(mapinit_30008_1);
			if (meta_app_data.drop_30008 != 1) {
				apply(filter_30008_2);
				if (meta_app_data.drop_30008 != 1) {
					apply(map_30008_3);
					if (meta_app_data.drop_30008 != 1) {
						apply(mark_satisfied_30008);
					}
				}
			}
		}
...
control egress {
	if (standard_metadata.instance_type == 0) {
		...
		if (meta_app_data.satisfied_30008 == 1) {
			apply(add_out_header_30008);
		}
