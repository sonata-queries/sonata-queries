...
action do_map_10032_2(){
	bit_and(meta_mapinit_10032_1.ipv4_srcIP, meta_mapinit_10032_1.ipv4_srcIP, 0xffffffff);
}
...
action do_init_distinct_10032_4(){
	modify_field_with_hash_based_offset(meta_distinct_10032_4.index, 0, hash_distinct_10032_4, 65536);
	register_read(meta_distinct_10032_4.value, distinct_10032_4, meta_distinct_10032_4.index);
}

action do_update_distinct_10032_4(){
...
table update_distinct_10032_4 {
	actions {
		do_update_distinct_10032_4;
	}
	size : 1;
}
			...
			if (meta_app_data.drop_10032 != 1) {
				...
				if (meta_app_data.drop_10032 != 1) {
					...
					if (meta_app_data.drop_10032 != 1) {
						...
						if (meta_distinct_10032_4.value <= 0) {
							apply(pass_distinct_10032_4);
							apply(update_distinct_10032_4);
						}
						else {
